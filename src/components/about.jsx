        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have experience building websites, React and Ruby Projects.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>As coming from a Math and Physics background I have a very good understanding of Algorithms</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Frameworks</h3>
                    <p>I am currently building many small applications using React</p>
                </div>
                </div>
            </div>
            {/*
