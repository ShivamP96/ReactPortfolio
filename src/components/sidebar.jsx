        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Shivam Patel</a></h1>
              <span className="email"><i className="icon-mail"></i> patelsd96@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/patels97/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://github.com/ShivamP96" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
            ...
            <div className="colorlib-footer">
              ...
              <ol>
                <li>Eloquent Javscript</li>
                <li>React Mini Projects </li>
                <li>Execute Program by Gary Bernhardt</li> 
              </ol>
              </small></p>
              <p><small>
